 ...
 * seq can reach in this design.  store.md §14(60) records both, and
 ...
 * store.md §14(58) records what those cells are here and why.
 *
 ...
 * `pending=0' until they exist (store.md §14(61)).
 */
struct Monctx
{
	Srv	srv;
