 ...
 * store.md §14(53) records every cell that fills in and why; the
 ...
 * ring no longer holds it (store.md §14(50)).
 */
static int
 ...
 * what a directory has to do.  store.md §14(50) records it.
 */
static void
mapsopen(Req *r)
{
 ...
 * with role=instance,peer=i", and store.md §14(51) fixes what a
 ...
 * the same judgement (store.md §14(51)).
 *
 ...
 * tree that answers it (store.md §14(54)) — and no unit is going to
 ...
 * entitled to one answer (store.md §14(54)).  That is why this test
