 ...
 * no records, /status with `hasmap=no' (store.md §14(49)).  A map text
 ...
 * of those a string is (store.md §14(54)).
 */
Monctx*
 ...
 * (store.md §14(51)).
 *
 * store.md §14(51) fixes what a successful read is and why, and is
 ...
 * /health's `silent=<ms>' is a multiple of 1000 (store.md §14(56)).
 */
void
