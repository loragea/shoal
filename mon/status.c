 ...
 * (store.md §14(49)): zero bytes is indistinguishable from a
 ...
 * second, against a `deadms' that defaults to ten (store.md §14(56)).
 ...
 * does not exist yet (store.md §14(49)).
 *
