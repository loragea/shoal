...
replfullq(Req *r, Srvctx *c, Sfid *f, Hdr *h)
{
	 ...
	 * (store.md §14(44), obj.c).  Both stage calls have returned, so no
	 ...
	 * free out of the slot (store.md §14(44), obj.c).  The two exits
 ...
 * it and takes the fid.  store.md §14(41) records the reading, and
