...
| `docs/design/store.md` | The per-instance local object store and the monitor's map store: on-disk format, write/read paths, recovery, space, group commit, tooling. On-disk truth lives here. |
